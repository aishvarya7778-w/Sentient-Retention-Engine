...
export const AuditLogTable = ({ logs: auditLogs = [], searchTerm = '', onSearch = () => {} }) => {
  ...
  return (
    <div className="bg-[#0f1712]/80 backdrop-blur-md border border-[#1a281e] rounded-xl p-5 flex-1 flex flex-col min-h-[400px]">
...
export const LiveEventCard = (props) => {
  ...
  return (
    <div className="bg-[#0f1712]/80 backdrop-blur-md border border-[#1a281e] rounded-xl p-4 flex justify-between items-center group hover:border-[#2a4230] transition-colors relative overflow-hidden shrink-0 animate-event-in">
