...
def node_output_formatter(state: RetentionState) -> Dict[str, Any]:
    ...
    payload = {
        ...
        "reasoning": state.get("assessment_reasoning")
    }
...
def node_audit_log(state: RetentionState) -> Dict[str, Any]:
    ...
    return {
        "audit_log": logs,
        "assessment_reasoning": f"Audit log entry created for {state.get('customer_id')}.",
...
def node_final_output(state: RetentionState) -> Dict[str, Any]:
    ...
    return {
        "assessment_reasoning": "Pipeline execution successfully completed with optimal strategy.",
...
def node_feedback_capture(state: RetentionState) -> Dict[str, Any]:
    ...
    return {
        ...
        "assessment_reasoning": f"Feedback loop {current_loops + 1} initiated. Re-evaluating strategy with new context.",
...
def node_memory_high(state: RetentionState) -> Dict[str, Any]:
    ...
    return {
        "assessment_reasoning": "Consolidated simulation history for high-risk strategy selection.",
...
def node_memory_low(state: RetentionState) -> Dict[str, Any]:
    ...
    return {
        "assessment_reasoning": "Consolidated simulation history for engagement strategy selection.",
        "message": "Analyzing simulation performance..."
    }
